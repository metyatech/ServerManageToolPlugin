...
This guide covers the plugin's editor configuration, local PIE server lifecycle, and Blueprint API. It does not document building, deploying, hosting, or operating a production dedicated server. The supported verification target for this package is UE 5.8 Win64; real project integration remains the responsibility of the project team.
