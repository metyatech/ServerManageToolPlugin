...
const header = (eyebrow, title, version = true) => `<header class="topbar"><img src="${assets.icon}" alt="Server Manage Tool product icon"><div><div class="brand">Server Manage Tool</div><div class="version">${version ? "Version 1.1.2 · Fab listing media" : ""}</div></div><div class="badge">UE 5.8 · Win64</div></header><div class="eyebrow">${eyebrow}</div><h1>${title}</h1>`;
